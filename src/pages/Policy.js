    ...
    <Layout title={"Privacy Policy"}>
      <div className="row contactus ">
        ...
        <div className="col-md-4">
          <p>Welcome to TECHBUD. We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy is designed to help you understand how we collect, use, disclose, and safeguard your data when you visit our E-commerce platform.</p>
